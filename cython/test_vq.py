...
# From: https://github.com/scipy/scipy/blob/7ecbcb8c2ebcbb8c87d2fc98a98bbc9f7e34f497/scipy/cluster/tests/test_vq.py#L162
...
@pytest.mark.parametrize('vq',
                         [cython_vq, 
                          # Put SPy version here
                          ])
def test_vq(vq):
    initc = np.concatenate([[X[0]], [X[1]], [X[2]]])
    label1, _ = vq.vq(np.asarray(X), np.asarray(initc))
